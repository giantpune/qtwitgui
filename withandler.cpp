	...
	case witDump:
		{
			...
			{
				str = str.trimmed();
				if( str.contains( "File & disc type:" ) )
				{
					str.remove( 0, 17 );
					str = str.trimmed();
				...
				else if( str.contains( "Disc & part IDs:" ) )
				{
					str.remove( 0, 16 );
					str = str.trimmed();
					str.remove( 0, 5 );
				...
				else if( str.contains( "System version:" ) && !type.contains( "GC" ) )
				{
			...
			int dashes = stdStr.indexOf( ", disk usage" );
